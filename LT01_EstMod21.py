...
# Procedimento
def p_media(nota1, nota2, nota3, nota4):
    media = ((nota1 + nota2 + nota3 + nota4) / 4)
    if media >= 6:
        print(f'O aluno teve media de: {media} - Ele está APROVADO')
    elif media >= 3 or media < 6:
        print(f'O aluno teve media de: {media} - Ele está de EXAME')
    else:
        print(f'O aluno teve media de: {media} - Ele está RETIDO')
...
p_media(nota1, nota2, nota3, nota4)  # Chamamento do Procedimento
